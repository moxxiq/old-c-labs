...
\chapter{Алфавітний покажчик структур даних}
\input{annotated}
\chapter{Покажчик файлв}
\input{files}
\chapter{Структури даних}
\input{structAEROFLOT__STRUCT}
\input{structsingle__linked__list__aeroflot__struct}
\chapter{Файли}
\input{lab__functions_8h}
\input{main_8c}
